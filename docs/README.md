...
These docs follow the [Diátaxis](https://diataxis.fr/) structure. Start with the
...
- [Search logs](how-to/search-logs.md) — `log_tail`, `log_grep` (regex), and the opt-in `keyword` mode.
